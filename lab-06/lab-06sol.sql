...
SELECT DEP_ID, COUNT(*) AS NUMBER_OF_STUDENTS
FROM STUDENT
GROUP BY DEP_ID;

-- Q7: Number of faculty members in each department
SELECT DEP_ID, COUNT(*) AS NUMBER_OF_FACULTY
FROM FACULTY
GROUP BY DEP_ID;

-- Q8: Number of courses offered by each department
SELECT DEP_ID, COUNT(*) AS NUMBER_OF_COURSES
FROM COURSE
GROUP BY DEP_ID;
...
SELECT DEP_ID, COUNT(*) AS TOTAL_COURSES
FROM COURSE
GROUP BY DEP_ID
HAVING COUNT(*) > 1;
...
SELECT DEP_ID, COUNT(STUDENT_ID) AS TOTAL_STUDENTS
FROM STUDENT
GROUP BY DEP_ID;
...
SELECT DEP_ID, COUNT(COURSE_ID) AS TOTAL_COURSES
FROM COURSE
GROUP BY DEP_ID;
